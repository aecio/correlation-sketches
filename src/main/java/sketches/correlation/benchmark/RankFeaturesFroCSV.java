...
public class RankFeaturesFroCSV {

    @SuppressWarnings("unused")
    private static final Logger logger = LoggerFactory.getLogger(RankFeaturesFroCSV.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        ColumnPair columnPair = Tables.createColumnPair(
                datasetPath,
